...
var user_entity_1 = require("./entities/user.entity/user.entity");
...
var UsersService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        user = this.userRepository.create(__assign(__assign({}, createUserDto), { password: hashedPassword }));
    ...
    UsersService.prototype.updateRefreshToken = function (userId, refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            var hashedToken, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        hashedToken = _a;
                        return [4 /*yield*/, this.userRepository.update(userId, { refreshToken: hashedToken })];
                    case 4:
                        _b.sent();
                        return [2 /*return*/];
                }
